...
public class MuseologicalObject {
	...
	public void setId(Long objectId) {
		((MuseologicalObject) this).objectId = objectId;
	}
	...
	public void setName(String name) {
		((MuseologicalObject) this).name = name;
	}
	...
	public void setObjectType(Boolean objectType) {
		((MuseologicalObject) this).objectType = objectType;
	}
	...
	public void setDate(Calendar date) {
		((MuseologicalObject) this).date = date;
	}
	...
	public MuseologicalObject createObject(String name, Calendar date) {
		((MuseologicalObject) this).name = name;
		((MuseologicalObject) this).date = date;
		return ((MuseologicalObject) this);
	}
